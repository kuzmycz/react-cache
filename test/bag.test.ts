...
describe('Create Bag', () => {
  test('Create a bag of values', () => {
    const values = {name: 'Donald Duck', address: {street: '1 Disney Way', city: 'Some Place', state: 'Florida', zip: '01702'}};
...
describe('Set Bag Items', () => {
  ...
  test("Set setting an new item", () => {
    const values: any = {name: 'Donald Duck', address: {street: '1 Disney Way', city: 'Some Place', state: 'Florida', zip: '01702'}};
    const initialContent = deepCopy(values);
    const bag = Bag.of(values);
    const item = "Male";
    const key = 'gender';
